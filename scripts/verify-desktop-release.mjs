...
try {
  ...
  assertMarkers("main process", main, {
    ...
    "durable structured progress recovery": ["structuredRuns", "Workflow progress is invalid.", "interrupted"],
    "independent progress and frozen dossier evidence": ["structured-today-state-v1.sqlite", "desktop:structured-progress", "v8-frozen-evidence", "frozenContent"],
